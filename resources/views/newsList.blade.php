                        ...
                        @foreach($item->copy_history as $history)
                            <div class="card" style="">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('news-single') }}" method="post">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="news" value="{{ json_encode($items[$k]) }}">
                                        <button type="submit" class="btn btn-primary">View News</button>
                                    </form>
                                </div>
                            </div>
                        @endforeach
